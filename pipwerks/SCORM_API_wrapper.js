...
(function (root, factory) {
    ...
    pipwerks.SCORM.connection.initialize = function () {
        let success = false;
        const scorm = pipwerks.SCORM;
        let { completionStatus } = scorm.data;
        const { trace } = pipwerks.UTILS;
        const makeBoolean = pipwerks.UTILS.StringToBoolean;
        const { debug } = scorm;
    ...
    pipwerks.SCORM.connection.terminate = function () {
        let success = false;
        const scorm = pipwerks.SCORM;
        const { exitStatus } = scorm.data;
        const { completionStatus } = scorm.data;
        const { trace } = pipwerks.UTILS;
        const makeBoolean = pipwerks.UTILS.StringToBoolean;
        const { debug } = scorm;
